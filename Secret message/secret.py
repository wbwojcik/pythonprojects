...
def main_screen():
    ...
    Label(text="Enter text for encyption and decryption",fg="black",font=("calibri",13)).place(x=10,y=10)
    ...
    Button(text="ENCRYPT",height="2",width=23,bg="#ed3823",fg="white",bd=0,command=encrypt).place(x=10,y=250)
